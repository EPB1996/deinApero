package ch.meinapero.config;

import static org.springframework.security.web.server.util.matcher.ServerWebExchangeMatchers.pathMatchers;

import ch.meinapero.security.AuthoritiesConstants;
import ch.meinapero.security.jwt.JWTFilter;
import ch.meinapero.security.jwt.TokenProvider;
import ch.meinapero.web.filter.SpaWebFilter;
...
public class SecurityConfiguration {
    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        ...
        .and()
            ...
            .pathMatchers("/api/product-categories").permitAll()
            .pathMatchers("/api/orders").permitAll()
            .pathMatchers("/api/customers").permitAll()
            .pathMatchers("/api/order-items").permitAll()
