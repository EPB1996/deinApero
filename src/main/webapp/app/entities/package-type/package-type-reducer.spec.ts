...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PACKAGETYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PACKAGETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PACKAGETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PACKAGETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PACKAGETYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PACKAGETYPE actions', async () => {
      const expectedActions = [
        {
