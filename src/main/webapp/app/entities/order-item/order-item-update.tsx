  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="meinAperoApp.orderItem.home.createOrEditLabel" data-cy="OrderItemCreateUpdateHeading">
            <Translate contentKey="meinAperoApp.orderItem.home.createOrEditLabel">Create or edit a OrderItem</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('meinAperoApp.orderItem.quantity')}
              ...
              />
              <ValidatedField
                label={translate('meinAperoApp.orderItem.totalPrice')}
              ...
              <ValidatedField
                ...
                name="product"
                data-cy="product"
                label={translate('meinAperoApp.orderItem.product')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="order"
                data-cy="order"
                label={translate('meinAperoApp.orderItem.order')}
                type="select"
                required
              >
                <option value="" key="0" />
