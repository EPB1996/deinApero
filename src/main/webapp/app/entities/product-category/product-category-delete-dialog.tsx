...
export const ProductCategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="meinAperoApp.productCategory.delete.question">
        <Translate contentKey="meinAperoApp.productCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
