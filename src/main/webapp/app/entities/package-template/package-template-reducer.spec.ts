...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PACKAGETEMPLATE_LIST actions', async () => {
    ...
    it('dispatches FETCH_PACKAGETEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PACKAGETEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PACKAGETEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PACKAGETEMPLATE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PACKAGETEMPLATE actions', async () => {
      const expectedActions = [
        {
