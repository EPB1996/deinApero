...
import ch.meinapero.MeinAperoApp;
import ch.meinapero.config.AsyncSyncConfiguration;
import ch.meinapero.config.EmbeddedMongo;
...
@SpringBootTest(classes = { MeinAperoApp.class, AsyncSyncConfiguration.class })
@EmbeddedMongo
